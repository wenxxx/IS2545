...
public class MainPanel extends JPanel {
	...
	/*
	 * Improvement 1
	 * MainPanel.convertToInt() is improved here
    ...
    public int getNumNeighbors0(int x, int y) {
	int size = _size;
	int leftX = (x - 1) % size;
	int rightX = (x + 1) % size;
	int upY = (y - 1) % size;
    ...
    public int getNumNeighbors1(int x, int y) {
	int size = _size;
	int leftX = (x - 1) % size;
	int rightX = (x + 1) % size;
	int upY = (y - 1) % size;
	...
	int numNeighbors = getNumNeighbors1(x, y);
	if (alive) {
	...
	/*
	 * Improvement 2
	 * MainPanel.backup is improved here
	 * backup0 represents the previous one
	 * backup1 represents the revised one
	 */
    public void backup0() {
